...
export function buildConfig(): any[] {
  ...
  items.push({ type: 'section', items: [
    ...
    { type: 'select', messageKey: 'SnoozeMax', label: 'Total snooze time',
      defaultValue: '30', id: 'snooze-max',
      description: 'How many minutes of snoozing are allowed in total before '
                 + 'the alarm must be stopped, however many presses that takes.',
      options: [
        { label: 'Unlimited', value: '0' }, { label: '5 min', value: '5' },
        { label: '10 min', value: '10' }, { label: '15 min', value: '15' },
